...
public class LuceneKnnBinaryQuantizedVectorFormat extends KnnVectorsFormat {
    private static final String FORMAT_NAME = "LuceneKnnBinaryQuantizedVectorFormat";
    ...
    public LuceneKnnBinaryQuantizedVectorFormat() {
        this(Integer.MAX_VALUE, HnswConfig.DUMMY);
    }

    /// Used for writing and created programmatically when creating the IndexWriter
    public LuceneKnnBinaryQuantizedVectorFormat(int maxDimensions, HnswConfig hnswConfig) {
        super(FORMAT_NAME);
