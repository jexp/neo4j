...
class Lucene10IndexWriter implements LuceneIndexWriter {
    private final IndexWriter indexWriter;

    Lucene10IndexWriter(IndexWriter indexWriter) {
    ...
    public LuceneDirectoryReader directoryReader() throws IOException {
        ...
        return new Lucene10DirectoryReader(directoryReader);
    }
    ...
    public void addIndexes(LuceneDirectory directory) throws IOException {
        indexWriter.addIndexes(((Lucene10Directory) directory).directory);
    }
    ...
    public LuceneDocumentsFactory documentFactory() {
        return Lucene10DocumentsFactory.INSTANCE;
    }
    ...
    private static Document toInternalDocument(LuceneDocument document) {
        return ((Lucene10Document) document).document;
    }
