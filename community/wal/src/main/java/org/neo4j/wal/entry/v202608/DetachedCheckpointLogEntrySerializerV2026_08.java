 ...
 */
package org.neo4j.wal.entry.v202608;
...
public class DetachedCheckpointLogEntrySerializerV2026_08
        extends LogEntrySerializer<LogEntryDetachedCheckpointV2026_08> {
    public static final int RECORD_LENGTH_BYTES = 486;
    public static final int MAX_DESCRIPTION_LENGTH = 329;
    ...
    public DetachedCheckpointLogEntrySerializerV2026_08() {
        super(DETACHED_CHECK_POINT_V5_0);
    }

    @Override
    public LogEntryDetachedCheckpointV2026_08 parse(
    ...
    @Override
    public int write(WritableChannel channel, LogEntryDetachedCheckpointV2026_08 logEntry) throws IOException {
        // Header
