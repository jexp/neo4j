...
public class EnvelopedLogHeaderCacheImpl implements EnvelopedLogHeaderCache {
    ...
    @Override
    public synchronized List<LogHeader> currentLogHeaders(boolean reversed) {
    ...
    public static class LogCacheBinarySearch implements LogBinarySearch.BinarySearchReader {
        ...
        public int compare(long version, long targetEntryIndex) {
            ...
            var logHeader = EnvelopedLogHeaderCacheImpl.get(logHeaders, version);
            if (logHeader != null) {
