...
import static org.neo4j.wal.entry.LogEntryTypeCodes.DETACHED_CHECK_POINT_V5_0;
...
import org.neo4j.wal.entry.LogEntrySerializer;
import org.neo4j.wal.entry.LogEnvelopeHeader;

public class DetachedCheckpointLogEntrySerializerV2026_10
        extends LogEntrySerializer<LogEntryDetachedCheckpointV2026_10> {
    public static final int RECORD_LENGTH_BYTES = 486;
    public static final int MAX_DESCRIPTION_LENGTH = 321;
    ...
    public DetachedCheckpointLogEntrySerializerV2026_10() {
        super(DETACHED_CHECK_POINT_V5_0);
    }

    @Override
    public LogEntryDetachedCheckpointV2026_10 parse(
        ...
        long consensusIndex = channel.getLong();
    ...
    @Override
    public int write(WritableChannel channel, LogEntryDetachedCheckpointV2026_10 logEntry) throws IOException {
        // Header
        ...
        channel.putLong(checkpointedLogPosition.getLogVersion())
                ...
                .putLong(logEntry.getConsensusIndex())
                .putShort(length)
