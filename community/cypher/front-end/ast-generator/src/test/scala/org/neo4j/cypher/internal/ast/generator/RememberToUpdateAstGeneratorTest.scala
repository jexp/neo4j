...
object RememberToUpdateAstGeneratorTest {
  ...
  val ignoreAstClasses: Set[String] = Set(
    ...
    "org.neo4j.cypher.internal.expressions.CompileEntityFilter",
    ...
    "org.neo4j.cypher.internal.util.symbols.BFloat16Type",
    ...
    "org.neo4j.cypher.internal.util.symbols.Float16Type",
