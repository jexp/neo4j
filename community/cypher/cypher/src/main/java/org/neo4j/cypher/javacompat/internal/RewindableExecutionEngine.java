...
public class RewindableExecutionEngine
{
     ...
     */
    public RewindableExecutionEngine( GraphDatabaseService database )
    {
     ...
     */
    public RewindableExecutionEngine( GraphDatabaseService database, StringLogger logger )
    {
    ...
    {
        return new org.neo4j.cypher.internal.RewindableExecutionEngine( database, logger );
    }
