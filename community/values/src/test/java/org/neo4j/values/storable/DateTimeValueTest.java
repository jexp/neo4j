...
class DateTimeValueTest {
    ...
    void shouldParseDateTime() {
        ...
        assertEquals(
                datetime(date(2015, 2, 1), time(5, 6, 7, 123456789, UTC)), parse("2015-02T5:6:7.123456789Z", orFail));
        assertEquals(
                datetime(date(2015, 2, 1), time(5, 6, 7, 123456789, UTC)), parse("2015-032T5:6:7.123456789Z", orFail));
    ...
    void shouldRejectInvalidDateTimeString() {
        ...
        // Wrong month
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-13-17T17:14:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for MonthOfYear");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-00-17T17:14:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for MonthOfYear");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-13-17T17:14:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for MonthOfYear");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-00-17T17:14:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for MonthOfYear");

        // Wrong day of month
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-32T17:14:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for DayOfMonth");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-00T17:14:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for DayOfMonth");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-32T17:14:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for DayOfMonth");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-00T17:14:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for DayOfMonth");

        // Wrong hour
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T24:14:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for HourOfDay");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T24:14:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for HourOfDay");

        // Wrong minute
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T17:60:35", inUTC))
                        .getMessage())
                .startsWith("Invalid value for MinuteOfHour");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T17:60:35Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for MinuteOfHour");

        // Wrong second
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T17:14:61", inUTC))
                        .getMessage())
                .startsWith("Invalid value for SecondOfMinute");
        assertThat(assertThrows(TemporalParseException.class, () -> parse("2017-12-17T17:14:61Z", orFail))
                        .getMessage())
                .startsWith("Invalid value for SecondOfMinute");
    ...
    void shouldAcquireCurrentDateTime() {
        ...
        assertEqualTemporal( // Using the named UTC timezone
                datetime(ZonedDateTime.now(clock.withZone("UTC"))), DateTimeValue.now(clock, "UTC"));

        assertEqualTemporal( // Using the timezone defined as 0 hours offset from UTC
                datetime(ZonedDateTime.now(clock.withZone(UTC))), DateTimeValue.now(clock, "Z"));
    }
    ...
    void shouldRejectInvalidComponentValues() {
        asserting(fromValues(builder(clock)))
                .add("year", 2018)
                .add("moment", 12)
                .assertThrows(InvalidArgumentException.class, "No such field: moment");
        asserting(fromValues(builder(clock)))
                .add("year", 2018)
                .add("month", 12)
                .add("day", 5)
    ...
    void shouldSubtractDurationFromDateTimes() {
        assertEquals(
                datetime(date(2018, 1, 1), time(1, 2, 3, 0, UTC)),
