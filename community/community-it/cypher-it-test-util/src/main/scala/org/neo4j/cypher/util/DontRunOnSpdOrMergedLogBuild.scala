...
import org.neo4j.test.TestDatabaseManagementServiceFactorySupplier.isMergedLog
import org.neo4j.test.TestDatabaseManagementServiceFactorySupplier.isSpd
import org.scalatest
import org.scalatest.Args
import org.scalatest.Status

trait DontRunOnSpdOrMergedLogBuild extends CypherITTestSuite {

  override protected def runTests(testName: Option[String], args: Args): Status = {
    if (isSpd || isMergedLog) scalatest.SucceededStatus
